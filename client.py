...
def createTicket():
    ...
    global ticketGrid
    # Ticket Frame
    mianLable = Label(gameWindow, width=87, height=20,relief='ridge', borderwidth=5, bg='white')
...
def gameWindow():
    ...
    # Flash Number Label
    flashNumberLabel = canvas2.create_text(400,450, text = "Waiting for other players to join...", font=("Chalkboard SE",30), fill="#3e2723")
...
def askPlayerName():
    ...
    button = tk.Button(nameWindow, text="Save", font=("Chalkboard SE", 30),width=11, command=saveName, height=2, bg="coral", bd=3)
    button.place(x = screen_width/6, y=screen_height/2)
